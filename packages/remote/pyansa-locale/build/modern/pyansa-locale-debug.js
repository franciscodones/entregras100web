...
Ext.define('Pyansa.locale.data.validator.CIDRv6', {override:'Ext.data.validator.CIDRv6', message:'No es un bloque CIDR válido'});
Ext.define('Pyansa.locale.data.validator.Number', {override:'Ext.data.validator.Number', config:{message:'No es un número válido'}});
Ext.define('Pyansa.locale.data.validator.Currency', {override:'Ext.data.validator.Currency', message:'No es una cantidad de moneda válida'});
Ext.define('Pyansa.locale.data.validator.Date', {override:'Ext.data.validator.Date', message:'No es una fecha válida'});
Ext.define('Pyansa.locale.data.validator.DateTime', {override:'Ext.data.validator.DateTime', message:'No es una fecha y hora válidas'});
Ext.define('Pyansa.locale.data.validator.Email', {override:'Ext.data.validator.Email', message:'No es una dirección de correo electrónico válida'});
Ext.define('Pyansa.locale.data.validator.Exclusion', {override:'Ext.data.validator.Exclusion', message:'Es un valor que ha sido excluido'});
Ext.define('Pyansa.locale.data.validator.IPAddress', {override:'Ext.data.validator.IPAddress', message:'No es una dirección IP válida'});
Ext.define('Pyansa.locale.data.validator.Inclusion', {override:'Ext.data.validator.Inclusion', message:'No está en la lista de valores aceptables'});
Ext.define('Pyansa.locale.data.validator.Length', {override:'Ext.data.validator.Length', minOnlyMessage:'La longitud debe ser al menos {0}', maxOnlyMessage:'La longitud no debe ser mayor que {0}', bothMessage:'La longitud debe estar entre {0} y {1}'});
Ext.define('Pyansa.locale.data.validator.Presence', {override:'Ext.data.validator.Presence', config:{message:'Debe estar presente'}});
Ext.define('Pyansa.locale.data.validator.Phone', {override:'Ext.data.validator.Phone', message:'No es un número de teléfono válido'});
Ext.define('Pyansa.locale.data.validator.Range', {override:'Ext.data.validator.Range', minOnlyMessage:'Debe ser al menos {0}', maxOnlyMessage:'No debe ser más que {0}', bothMessage:'Debe estar entre {0} y {1}'});
Ext.define('Pyansa.locale.data.validator.Time', {override:'Ext.data.validator.Time', message:'No es una hora válida'});
Ext.define('Pyansa.locale.data.validator.Url', {override:'Ext.data.validator.Url', message:'No es una URL válida'});
Ext.define('Pyansa.locale.field.Field', {override:'Ext.field.Field', config:{requiredMessage:'Este campo es obligatorio', validationMessage:'Esta en el formato incorrecto'}});
