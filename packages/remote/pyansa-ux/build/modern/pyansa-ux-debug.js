...
Ext.define('Pyansa.overrides.MessageBox', {override:'Ext.MessageBox', config:{maxWidth:500}, statics:{LOADING:Ext.baseCSSPrefix + 'msgbox-loading'}});
Ext.define('Pyansa.overrides.field.Date', {override:'Ext.field.Date', useNativeInput:true, initialize:function() {
  var me = this, nativeInput, inputElem;
