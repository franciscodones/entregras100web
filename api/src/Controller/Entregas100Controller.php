...
class Entregas100Controller extends AppGaseraController {
    ...
    public function index() {
        ...
        $aQueryParams = array($nUnidad, $nEmpresa);
        $aResultado = $oConexion->query($sQuery, $aQueryParams);
        $aUnidad = count($aResultado) == 0 || $aResultado[0]['plaza_id'] <= 0 ? null : $aResultado[0];
        if ($aUnidad == null) {
            return $this->asJson(array(
                "success" => false,
        ...
        $sFuncion = str_replace("_", "", $sFuncion); // elimina los `_` para adaptarse a cakephp3
        $sController = "App\\Controller\\Entregas100\\" .$sFuncion . 'AppGaseraController';

        // realiza el log_ws
        $sQuery = "INSERT INTO logs_ws(".
            "unidad_id, ".
            "sistema_key, ".
            "funcion, ".
            "fecha, ".
        ...
        $logWSId = $oConexion->driver()->lastInsertId();
