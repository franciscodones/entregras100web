 ...
 */
	Configure::write('Error', array(
		'handler' => function ($code, $description, $file = null, $line = null, $context = null) {
			// NOTA: Los siguientes errores no podran ser manejados por esta funcion:
			//
			// * E_ERROR
			// * E_PARSE
			// * E_CORE_ERROR
			...
			// Si el level del reporte es 0 no se realiza ninguna accion.
			// Este valor cambia de acuerdo a la configuracion dada por `level` que se encuentra mas abajo.
